 ...
 * @since 1.0.0
*/
if (!class_exists('Coherence_Post_Type_Pricing')) {
    class Coherence_Post_Type_Pricing
    {
        ...
        function create_post_type()
        {
            ...
            $slug = $this->slug;
            $labels = array(
                'name'                  => esc_html_x('Pricing', 'Post Type General Name', 'coherence-core'),
                'singular_name'         => esc_html_x('Pricing', 'Post Type Singular Name', 'coherence-core'),
    ...
    Coherence_Post_Type_Pricing::getInstance();
} //endif 