 ...
 * @since 1.0.0
*/
if (!class_exists('Coherence_Post_Type_Project')) {
    class Coherence_Post_Type_Project
    {
        ...
        function create_post_type()
        {
            ...
            $slug = $this->slug;
            $labels = array(
                'name'                  => esc_html_x('Project', 'Post Type General Name', 'coherence-core'),
                'singular_name'         => esc_html_x('Project', 'Post Type Singular Name', 'coherence-core'),
    ...
    Coherence_Post_Type_Project::getInstance();
} //endif 