...
class CrellySliderAdmin
{
	...
	{
		add_menu_page('Wetheme Slider', 'Wetheme Slider', CS_MIN_CAPABILITY, 'crellyslider', 'CrellySliderAdmin::displayPage', 'div');
	}
...
?>
		<div class="wrap cs-admin" <?php if ($edit && isset($slider)) : ?> style="width: <?php echo esc_attr($slider->startWidth); ?>px;" <?php else : ?> style="width: 1140px;" <?php endif; ?>>
			...
			<h2 class="cs-logo" title="Crelly Slider">
				<a href="?page=crellyslider">
					WeTheme Slider
					<?php //echo CS_PLUGIN_URL . '/wordpress/images/logo2.png' 
					?>
				</a>
			</h2>
