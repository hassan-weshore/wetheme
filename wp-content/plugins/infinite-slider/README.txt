=== Infinite Slider ===
Contributors: kinstahosting
Tags: slider, gallery, image, images, media, photo, photo albums, photos, picture, pictures, slideshow, thumbnails
Donate link: https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&business=paypal@kinsta.com&item_name=Donation+for+Infinite+Slider
...
Web users are starting to get bored by the currently prevailing trend of one huge image at the top of the website usually followed by a couple of more slides *if* the user waits enough! They usually don't...

That's where Infinite Slider comes in: it brings the best content of your site to the surface via beautiful Featured Images that you (usually) have added to all your posts anyways! By featuring at least 20 (or more!) tiles on your page with images, description and a read more button in the focus area you'll surely get more interaction that with any other "regular" slider plugins out there. It's a truly innovative and unique idea that's now available to all WordPress owners for free! No "pro" versions, no paid support; just like in the old days of WP.org plugins! :) Enjoy.

Created and maintained by: [Kinsta WordPress Hosting](http://www.kinsta.com)
Check out our [live Infinite Slider demo site](http://www.kinsta.com/demo/infinite-slider/)!
...
Upload the ZIP file via WordPress Admin Dashboard and activate the plugin. It's recommended to activate one other plugin: Force Regenerate Thumbnails. Please run Force Regenerate Thumbnails at least once after you've activated Infinite Slider so the slider can display the images in the correct size!

= Using The WordPress Dashboard =

1. Navigate to the 'Add New' in the plugins dashboard
2. Search for 'infinite-slider'
3. Click 'Install Now'
4. Activate the Infinite Slider plugin on the Plugin dashboard
...
= How do I display the slider on my site? =

Please use the `[infinite_slider]` shortcode! In order to hardcode it into your theme you can use the follwoing PHP code `<?php echo do_shortcode('[infinite_slider]') ?>`.

= Images are not displaying or are in a wrong size. =

Please run the Force Regenerate Thumbnails plugin at least once.

== Screenshots ==

1. This is how Infinite Slider looks 'in action' on our demo site.
2. This is a list of the current settings on the options page (as of v2.0.0).

== Changelog ==

= 2.0.1 =
* Added version 1.2 of Custom Metaboxes and Fields for WordPress class
...
= 2.0.0 =
If you have an older version of this plugin from any source, please upgrade by deleting the old plugin and installing this new one. Thank you.
