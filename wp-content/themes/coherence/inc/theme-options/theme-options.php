	...
	CSF::createSection($coherence_prefix . '_theme_options', array(
		...
		'fields' => array(
			...
			array(
				...
				'title'   => esc_html__('Widescreen', 'coherence'),
				'type'    => 'slider',
			...
			array(
				...
				'title'   => esc_html__('Laptop', 'coherence'),
				'type'    => 'slider',
			...
			array(
				...
				'title'   => esc_html__('Tablet Extra', 'coherence'),
				'type'    => 'slider',
			...
			array(
				...
				'title'   => esc_html__('Tablet', 'coherence'),
				'type'    => 'slider',
			...
			array(
				'id'      => 'mobile_extra_point',
				'title'   => esc_html__('Mobile Extra Breakpoint', 'coherence'),
				'type'    => 'slider',
				'subtitle'    => esc_html__('Controls when Laptop change layout. In pixels.'),
				'default' => 600,
				'step'    => 1,
				'unit'    => 'px',
				'min' => 497,
			...
			array(
				'id'      => 'mobile_break_point',
				'title'   => esc_html__('Mobile Breakpoint', 'coherence'),
				'type'    => 'slider',
				'subtitle'    => esc_html__('Widescreen breakpoint settings will apply from the selected value and up. In pixels.'),
				'default' => 497,
				'step'    => 1,
				'unit'    => 'px',
				'max' => 600,
